              ...
              {supabaseService.isConfigured() && (
                <>
                  <div className="relative flex py-2 items-center">
                    ...
                    <span className="flex-shrink mx-4 text-zinc-500 text-[10px] font-mono uppercase">Ou continuar com</span>
                    <div className="flex-grow border-t border-white/5"></div>
                  </div>
                  ...
                  <button
                    ...
                    disabled={isLoading}
                    className="w-full py-3 rounded-2xl bg-zinc-950/80 hover:bg-zinc-900 border border-white/10 text-white font-bold text-xs flex items-center justify-center gap-2.5 transition-all cursor-pointer hover:scale-[1.01]"
                  >
