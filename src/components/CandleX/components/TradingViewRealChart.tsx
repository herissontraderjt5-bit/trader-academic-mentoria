...
export const TradingViewRealChart: React.FC<TradingViewRealChartProps> = ({
  ...
  const getSymbol = (rawTicker: string) => {
    ...
    if (clean === "DOGEUSDT") return "BINANCE:DOGEUSDT";
    if (clean === "ADAUSDT") return "BINANCE:ADAUSDT";
    if (clean === "DYDX" || clean === "DYDXUSDT") return "BINANCE:DYDXUSDT";
    if (clean === "XAUUSD" || clean === "GOLD") return "OANDA:XAUUSD";
    if (clean === "AAPL") return "NASDAQ:AAPL";
    if (clean === "TSLA") return "NASDAQ:TSLA";
    if (clean === "BA") return "NYSE:BA";
    if (clean === "INTC") return "NASDAQ:INTC";
