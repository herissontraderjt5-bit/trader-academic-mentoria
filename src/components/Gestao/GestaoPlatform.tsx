...
const MainLayout: React.FC<MainLayoutProps> = ({ onBackToHome, onOpenCandleX }) => {
...
export interface GestaoPlatformProps {
  currentUser?: any;
  onBackToHome?: () => void;
  onOpenCandleX?: () => void;
}
